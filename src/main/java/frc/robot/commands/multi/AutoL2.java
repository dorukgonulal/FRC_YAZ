...
public class AutoL2 extends Command {
    ...
    /** Creates a new L3. */
    public AutoL2(ElevatorSubsystem elevatorSubsystem, CoralPivotSubsystem coralPivotSubsystem) {
    ...
    public void execute() {
        if(!coralSwitch.get()) {
            ...
            new ParallelCommandGroup(
                new ElevatorControlCommand(elevatorSubsystem, ElevatorPositions.L2),
