...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                // DENEME
                joystick.L1().onTrue(drivetrain.runOnce(
                                () -> drivetrain.resetPose(new Pose2d(drivetrain.getState().Pose.getTranslation(),
                                                new Rotation2d()))));
                // BUNU DA DENE
                // joystick.leftBumper().onTrue(drivetrain.runOnce(() -> {
                // var alliance = DriverStation.getAlliance();
                // var rotation = (alliance.isPresent() && alliance.get() == Alliance.Red)
                ...
                // PS5(bunu denemene gerek yok)
                // joystick.L1().onTrue(drivetrain.runOnce(() ->
                // drivetrain.seedFieldCentric()));lim
