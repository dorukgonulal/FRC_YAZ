...
public class TunerConstants {
    ...
    // NEED TO TUNE THESE GAINS BEFORE USING THE SWERVE DRIVE!
    // NEED TO TUNE THESE GAINS BEFORE USING THE SWERVE DRIVE!
    // NEED TO TUNE THESE GAINS BEFORE USING THE SWERVE DRIVE!
    // NEED TO TUNE THESE GAINS BEFORE USING THE SWERVE DRIVE!
    // NEED TO TUNE THESE GAINS BEFORE USING THE SWERVE DRIVE!
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.213); // 52.13
    ...
    private static final Distance kFrontLeftXPos = Inches.of(13.7); // 112.5
    private static final Distance kFrontLeftYPos = Inches.of(13.7);
    ...
    private static final Distance kFrontRightYPos = Inches.of(-13.7);
    ...
    private static final Distance kBackLeftYPos = Inches.of(13.7);
    ...
    private static final Distance kBackRightYPos = Inches.of(-13.7);
