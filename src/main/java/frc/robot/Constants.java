...
public final class Constants {
  ...
  //Kpler: autoalign 5-6ya çıkarılabilir., rotation pid 4-5 arasına çıkarılabilir.
  // Zınk diye durmaması için ufak bir kD eklenebilir(translational için 0.1-0.2, rotation için 0.1(Overshoot yoksa yapma varsa yap))
  ...
  public static final class AutoConstants {
    public static final PIDConstants kRotationPID = new PIDConstants(2, 0, 0);// ok
    ...
    public static final PathConstraints kTeleopPathConstraints = new PathConstraints(1.5, 1.0,
        Units.degreesToRadians(540), Units.degreesToRadians(720)); // The constraints for this path.

    public static final PathConstraints kAutoPathConstraints = new PathConstraints(1.5, 1, 1 / 2 * Math.PI,
