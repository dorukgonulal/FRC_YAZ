...
public final class Constants {
    ...
    public static class ElevatorConstants {
      ...
      public static final double ELEVATOR_SETPOINT_L2 = 34;
      public static final double ELEVATOR_AUTO_L2 = 39.7;

      public static final double ELEVATOR_SETPOINT_READYFORAUTO = 24;

      public static final double ELEVATOR_SETPOINT_L3 = 46; // 44
      public static final double ELEVATOR_SETPOINT_L4 = 75; // 69.5

      public static final double ELEVATOR_SETPOINT_AUTOL3 = 67.3;

      public static final double ELEVATOR_SETPOINT_ALGEA1 = 28.7931;
      public static final double ELEVATOR_SETPOINT_ALGEA2 = 46.269;
      public static final double ELEVATOR_SETPOINT_PROCESSOR = 71.31;
  ...
  public static final class PivotConstants {
    ...
    public static final double REEF_L2_L3 = -2.23;
    public static final double REEF_L4 = -2.569;
    public static final double BARGE = -0.52;
